...
Use a constrained Google-inspired palette: Google dark #202124, white, warm gray, dark gray, and Google blue #4285F4.
...
export async function POST(request: Request) {
  ...
  if (!isEventGateOpen(request)) {
    return jsonResponse(
      {
        error: "La generación estará disponible el 23 de mayo.",
      },
      { status: 403 },
    );
  }
